...
```{r, echo = FALSE,out.width="100%", fig.height=4, fig.width=9, fig.cap="Leaving response of the learners"}
...
```{r, echo = FALSE,out.width="100%", fig.height = 14, fig.width = 20, fig.cap="Enrolled and fully participated over different variables"}
...
Here for this analysis the count of each country was stored in a column. Now to compare the enrolments and the fully participated learners from each country, the data was normalized because number of learners enrolled were significantly more than the number of learners who fully participated in the course. So to plot on similar axis, noalization was needed.
...
```{r, echo = FALSE,out.width="100%",  fig.height=9, fig.width=16, fig.cap="Analysis of total views,HD views,captions & Transcript for video contents"}
# knitr::include_graphics("C:/Users/Payal/Desktop/Future_Learn_EDA_DM/graphs/video_stats_views_plot.png")
