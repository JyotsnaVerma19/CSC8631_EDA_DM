...
```{r, echo = FALSE,out.width="100%", fig.width = 12, fig.height=5, fig.cap="Leaving response of the learners"}
...
```{r, echo = FALSE,out.width="100%", fig.hight = 9, fig.width = 16, fig.cap="Enrolled and fully participated over different variables"}
